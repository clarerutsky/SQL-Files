...
-- PIVOT : TO REPORT UNIQUE VALUES OF A GIVEN COLUMN AS NEW COLUMNS
SELECT * FROM #ServiceSales
...
-- AGGREATES ARE FILLED IN THIS NEW COLUMNS

-- CATEGORY: CalendarYear
-- AGGREGATE: SalesAmount

-- CREATE A TEMPORARY RESULT AND THEN APPLY PIVOT ON THIS TEMPORARY RESULTSET
...
PIVOT (
	SUM(SalesAmount)  FOR CalendarYear IN ([2001], [2002], [2003], [2004])
	  ) as PivotQuery;
